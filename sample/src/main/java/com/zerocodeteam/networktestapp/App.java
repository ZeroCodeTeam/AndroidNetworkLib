...
public class App extends Application {
    ...
    public void onCreate() {
        ...
        // Init network module
        sInstance = new ZctNetwork.Builder(this).defaultDialogMsg(DEFAULT_MSG).defaultLoggingEnabled(false/*BuildConfig.DEBUG*/).defaultMinDialogTime(DEFAULT_DIALOG_TIME).build();
    }
}
