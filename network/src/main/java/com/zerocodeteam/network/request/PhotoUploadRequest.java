...
public class PhotoUploadRequest<T> extends GsonRequest<T> {
    ...
    public PhotoUploadRequest(String url, ResponseListener<T> listener, Class<T> clazz, Map<String, String> headers, Bitmap image, String imageName, Object cookie) {
        super(Method.POST, url, listener, clazz, headers, null, cookie);
        mImage = image;
